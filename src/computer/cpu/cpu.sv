...
module CPU(
    ...
    wire [15:0] r1o, r2o, r3o, r4o, spo, sbo, cso, sso, dso, eso, so, mo, io, pco;
    ...
    ALU alu(clk, bus, aluOpSel, aluASel, aluBSel, SO, r1o, r2o, r3o, r4o, spo, sbo, cso, sso, dso, eso, mo, pco, flagsIn);

    RegistersUnit regUnit(clk, r, bus, rsi, rso, R1I, R1O, R2I, R2O, R3I, R3O, R4I, R4O, CSI, CSO, DSI, DSO, SSI, SSO, ESI, ESO, segSel, II, IO, MI, MO, SPI, SPO, SBI, SBO, r1o, r2o, r3o, r4o, mo, io, spo, sbo, cso, sso, dso, eso, so);
